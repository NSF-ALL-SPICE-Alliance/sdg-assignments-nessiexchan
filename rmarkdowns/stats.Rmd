...
```{r}
goal_17_plot <- ggplot(sdr_data, aes(x = goal_17_score, 
...
ggplotly(goal_17_plot)
```

There is a moderately positive relationship with sustainable management of water and sanitation for all (Goal 6) and partnerships for these goals (Goal 17). This may indicate that having partners to carry out SDGs are good indicators for having sustainable mangaement of water and sanitation. However, some countries, such as Algeria, have partnerships, but have low management scores. This maybe due to unequal partnerships and some countries benefitting, while others do not.
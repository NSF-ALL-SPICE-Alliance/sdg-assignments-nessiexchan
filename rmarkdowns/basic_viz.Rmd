...
```{r}
ggplot(data = sdr_data, aes(x= goal_2_score, y = goal_6_score, color = goal_1_score)) +
  geom_point()
```
Interpretation:
Countries with higher goal 6 scores also have higher goal 1 scores. Very few countries have low goal 2 scores, but that also correlated to having lower goal 1 scores as well.
...
```
Interpretation:
Europe and Central Asia region along wth OECD have goal 3 scores above. In comparison, a majority of the Sub-Saharan African region have goal 3 scores of 50 or less.
